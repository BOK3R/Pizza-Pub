...
/**
 * Properties class for realised orders
 */
public class SalesFx {
    ...
    private IntegerProperty sale = new SimpleIntegerProperty();

    /**
     * Gets id value of Product
    ...
    /**
     * Gets sale value of Product
     * @return This Product sale value
     */
    public int getSale() {
        return sale.get();
    }
    ...
    /**
     * Gets sale property of Product
     * @return This Product sale property
     */
    public IntegerProperty saleProperty() {
        return sale;
    }

    /**
     * Sets sale value of Product
     * @param sale sale to set as value of sale property
     */
