...
/**
 * Controller class for LoginFormForServices.fxml;
 */
public class LoginFormForServicesController {
    ...
    public void onActionLogin(ActionEvent actionEvent) {
        ...
        if (ans == 3) {
            ...
            FXMLLoader loader = new FXMLLoader(this.getClass().getResource(MENU_FXML));
