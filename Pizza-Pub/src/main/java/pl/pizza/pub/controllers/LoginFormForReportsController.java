...
/**
 * Controller class for LoginFormForReports.fxml;
 */
public class LoginFormForReportsController {
    ...
    public void onActionLogin(ActionEvent actionEvent) {
        ...
        if (ans == 3) {
            ...
            FXMLLoader loader = new FXMLLoader(this.getClass().getResource(REPORTS_FXML));
