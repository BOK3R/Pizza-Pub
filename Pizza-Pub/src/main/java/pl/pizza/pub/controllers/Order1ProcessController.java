...
/**
 * Controller class of Order1Process.fxml
 */
public class Order1ProcessController {
    ...
    private void activeButtons() {
        currentOrderFirstButton.setDisable(true);
        currentOrderSecondButton.setDisable(true);

        currentOrderThirdButton.disableProperty().bind(Bindings.notEqual("gotowe do wydania", currentOrder.statusProperty()));
        currentOrderFourthButton.disableProperty().bind(Bindings.notEqual("oczekujące", currentOrder.statusProperty()));
    }
